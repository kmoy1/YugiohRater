...
// Usage examples:
//   node scripts/fill-pack.mjs --folder=LegendBEWD
//   node scripts/fill-pack.mjs --folder=LegendBEWD --default-rating=0 --review-text="TBD"
...
async function loadPackJson(folder) {
  const file = path.join(DATA_DIR, folder, 'cards.json')
...
async function main() {
  const { file, json } = await loadPackJson(FOLDER)
